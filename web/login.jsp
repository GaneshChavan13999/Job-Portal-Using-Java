        ...
        <div class="a1">
            <form action="Login"  method="post">
                ...
                <!--<label for="exampleInputEmail1">Email address</label>-->
                 <input type="email" class="form-control" id="exampleInputEmail1" name="email" placeholder="name@example.com" aria-describedby="emailHelp"  maxlength="100" aria-invalid="true" aria-required="true" maxlength="100" autocomplete="nope" data-v-13b9f01f="" data-vv-validate-on="blur">
                  <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
             </div>
             <div class="form-group">
                <!----<label for="exampleInputPassword1">Password</label>-->
                 <input type="password" class="form-control" name="ps" id="exampleInputPassword1" placeholder="password">
             </div>
            ...
            <a href="registerSeeker.jsp">Register Here</a>    
         </form>
        </div>
        </div>
        <!-- Scripts -->
